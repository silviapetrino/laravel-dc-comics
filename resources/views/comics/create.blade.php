...
<form action="{{ route('comics.store')}}" method="POST" class="comic bg-danger p-4 m-5 text-white fw-bold rounded">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="sale-date" name="sale_date" aria-describedby="emailHelp">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="artists" name="artists" aria-describedby="emailHelp">
    </div>
    <div class="mb-3">
        <label for="writers" class="form-label">Writers</label>
        <input type="text" class="form-control" id="writers" name="writers" aria-describedby="emailHelp">
    </div>
